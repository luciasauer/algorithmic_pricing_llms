...
class CalvanoDemandEnvironment:
    ...
    def compute_quantities_and_profits(
        ...
        try:
            ...
            profits = get_profits(
                p=tuple(price_values), a0=self.a_0, a=self.a, mu=self.mu,
                alpha=self.alpha, c=current_c, multiplier=self.beta, sigma=self.sigma, group_idxs=self.group_idxs,
            )
    ...
    def _compute_benchmarks(self):
        try:
            ...
            self.monopoly_prices = get_monopoly_prices(
                ...
                c=current_c, multiplier=self.beta, sigma=self.sigma, group_idxs=self.group_idxs,
            )
            ...
            self.nash_prices = get_nash_prices(
                a0=self.a_0, a=self.a, mu=self.mu, alpha=self.alpha, c=current_c,
