...
\fancyhead[L]{\cl}            % Kopfzeile links
\fancyhead[C]{}     % Zentrierte Kopfzeile
\fancyhead[R]{BSE - DSDM}          % Kopfzeile rechts
...
\usepackage[hang,flushmargin]{footmisc} % Control footnote behavior, here remove footnote intendation