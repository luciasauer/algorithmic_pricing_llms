...
\figureref{fig:monopoly_convergence} illustrates the results from one such experiment, showing the model’s rapid convergence to the monopoly price (represented by the dotted line), demonstrating the agent’s ability to set appropriate prices in this economic setting.
...
\include{latex/tables/monopoly_models}
